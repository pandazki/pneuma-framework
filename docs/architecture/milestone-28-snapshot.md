...
M28 preserves [ADR-0031](./adr/0031-open-ended-definition-artifact-boundary.md):
...
M28 is therefore the distribution companion to [ADR-0034](./adr/0034-code-change-lane-executor.md), not a replacement for schema-driven definition governance.
...
- [ADR-0035: Host Extension Slot Contract](./adr/0035-host-extension-slot-contract.md)
