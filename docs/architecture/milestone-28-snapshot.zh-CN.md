...
M28 保持 [ADR-0031](./adr/0031-open-ended-definition-artifact-boundary.md)：
...
因此 M28 是 [ADR-0034](./adr/0034-code-change-lane-executor.md) 的 distribution companion，不是 schema-driven definition governance 的替代品。
