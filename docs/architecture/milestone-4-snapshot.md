...
![M4 product substrate loop — viewer app calls Operation API, writes inbox_items rows into SQLite app.db, exposes Data view and Live substrate inspector, survives Docker restart, and can be replayed by the demo runner](./spec/images/m4-product-substrate-loop.png)
...
![M4 demo surface — one running app exposes three readable surfaces: end-user app, Data view, and Live substrate inspector](./spec/images/m4-demo-surface.png)
...
![M4 evidence matrix — capture, list/status, Data view, and substrate inspector are checked across Operation API, SQLite reopen, Docker restart, browser UI, demo runner, and docs](./spec/images/m4-evidence-matrix.png)
