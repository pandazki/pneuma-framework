...
![M5 Builder evolution loop - Builder request becomes governed definition rows and a running Priority Queue capability](../architecture/spec/images/m5-builder-evolution-loop.png)
...
![M5 evidence matrix - Builder evolution proof across automated tests, browser e2e, and snapshot documentation](../architecture/spec/images/m5-evidence-matrix.png)
