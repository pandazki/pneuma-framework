...
- Create `docs/architecture/milestone-45-snapshot.md`
- Create `docs/architecture/milestone-45-snapshot.zh-CN.md`
...
`docs/architecture/milestone-45-snapshot.md` must include:
