...
| **M48** | Workflow App Studio starts a cleaner real-product line: Bob creates a workflow app, real opencode edits controlled Generated App source (`src/app.ts`), Host guardrails/review/approval/apply govern the change, and preview/publish prove legal-review plus SLA-tracking runtime behavior. |
