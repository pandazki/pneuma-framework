...
- **Agent Debug Loop + Scaffold Project + Code Change Lane** for pre-proposal code-agent attempts and governed draft source changes.
...
| Lane | Read |
|---|---|
| **Build a Host** | [Getting Started](./getting-started.md), the [Scaffold To Host Walkthrough](./scaffold-to-host-walkthrough.md) (bridge from `scaffold-host` to a runnable Host), [Creation Host Contract](./creation-host-contract.md), [Creation Host Implementation Kit](./host-kit.md), then compare the compact [Reference Host](../../examples/reference-creation-host/README.md), the closed pressure sample [Product Creation Host](../../examples/product-creation-host/README.md), the real-product line [Workflow App Studio](../../examples/workflow-app-studio/README.md), the scaffold-first [Production Generated App Profile](./production-generated-app-profile.md), and the full profile-to-cloud flow [Production Profile Host Example](./production-profile-host.md). |
...
| **Adopt post-RC utilities** | [HostExtension Slots](./host-extension-slots.md), [Host Credential Broker Utilities](./credential-broker.md), and the upgrade guides: [0.4.0 → 0.5.0](./migration-0.4-to-0.5.md), [0.1.1](./upgrading-to-rc-0.1.1.md), [0.1.2](./upgrading-to-rc-0.1.2.md), [0.1.3](./upgrading-to-rc-0.1.3.md), [0.2.0](./upgrading-to-rc-0.2.0.md). |
| **Review current architecture** | [Global Alignment Review 0.4](../architecture/spec/global-alignment-review-0.4.md), [Creation Host Model](../architecture/spec/creation-host-model.md), [AI Build Assurance DDD Review](../architecture/spec/ai-build-assurance-domain-review.md), [Production Readiness Boundary](../architecture/spec/production-readiness-boundary.md), [Enterprise Governance Domain Review](../architecture/spec/enterprise-governance-domain-review.md), and [M51 Snapshot](../archive/milestone-51-snapshot.md). |
| **Review enterprise boundary** | [Global Alignment Review 0.3](../architecture/spec/global-alignment-review-0.3.md), [Production Readiness Boundary](../architecture/spec/production-readiness-boundary.md), [Enterprise Governance Domain Review](../architecture/spec/enterprise-governance-domain-review.md), [Runtime / Data Governance](./runtime-data-governance.md), [M43 Demo](../../examples/m43-enterprise-governance-demo/README.md), and [RC 0.3.0 Snapshot](../archive/release-candidate-0.3.0-snapshot.md). |
