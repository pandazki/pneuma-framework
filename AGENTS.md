...
16. **`docs/developer/enterprise-governance.md`** — minimum role-route review guide before publish readiness.
...
- M49 is active: Agent Debug Loop belongs before proposal creation. It gives Developers budgeted attempts, failed-check feedback, BuildThread debug evidence, and fail-closed no-proposal behavior; post-apply repair remains a new proposal, not silent code changes.
