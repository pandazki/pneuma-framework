...
| [`knowledge-inbox-core-domain`](./knowledge-inbox-core-domain/) | **canonical** | M4-M8 reference app on the M3 deployable substrate; captures, triages, evolves through `definition.apply_change_set`, hosts live Builder approval evidence, and now ships through release packaging smoke. In smoke suite. | just now |
