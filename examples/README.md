...
- **canonical** — currently the milestone demo target, actively maintained.
...
- The **canonical** example is the one to demo for team alignment: see [`docs/architecture/team-share-demo.md`](../docs/architecture/team-share-demo.md).
...
- M2 may introduce one new reference example as a "second-app pressure test" before milestone closure (see [`docs/architecture/roadmap.md`](../docs/architecture/roadmap.md) §"Stage 5").
