...
| [`m6-real-agent-evolution`](./m6-real-agent-evolution/) | **canonical** | M6 backend-agent evolution demo: AgentBackend session discovers framework tools and evolves Knowledge Inbox through `definition.apply`. | just now |
