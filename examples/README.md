...
- **canonical** examples are the current milestone demo targets. M1 remains the live browser governance story; M4 is the deployable reference app story; M5 is the Builder-evolved app story; M6 is the backend-agent tool-surface story; M7 is the live Builder approval protocol story.
...
- See [`docs/architecture/roadmap.md`](../docs/architecture/roadmap.md) for milestone sequencing. M7 is closed; the semantic index track remains deferred while real opencode interactive approval and release packaging hardening are the next likely pressure lines.
