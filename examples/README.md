...
| [`m18-open-ended-personal-focus-site`](./m18-open-ended-personal-focus-site/) | **canonical** | M18 open-ended app pressure demo: Personal Focus Site with UI definition, GitHub attention module, governed evolution, publish, restart, and rollback. | just now |
