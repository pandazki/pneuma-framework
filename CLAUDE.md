...
9. **`docs/superpowers/plans/2026-05-04-m17-security-architecture-acceptance.md`** — process input for M17, useful when inspecting the security and architecture acceptance boundary.
