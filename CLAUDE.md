...
9. **`docs/developer/host-kit.md`** — M45/M46 Creation Host Implementation Kit guide and current implementation-framework entry.
10. **`examples/reference-creation-host/README.md`** — compact canonical M45 consumer and runnable Team Notes Board workbench.
11. **`examples/product-creation-host/README.md`** — M46 product-shaped Dev Board Builder with browser E2E, share/fork, published-app use, and real opencode pressure.
