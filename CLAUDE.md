...
9. **`docs/developer/build-thread.md`**, **`docs/developer/scaffold-project-contract.md`**, **`docs/developer/code-change-lane.md`**, and **`docs/developer/build-assurance.md`** — governed creation/source-change/assurance lane.
